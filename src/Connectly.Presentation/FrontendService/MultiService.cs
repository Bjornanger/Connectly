...
namespace Connectly.Presentation.FrontendService;
...
public class MultiService 
{
    ...
    public IUserMeetingRegistrationFormService UserMeetingRegistrationFormService =>
        GetAccessToService<IUserMeetingRegistrationFormService>();
    #endregion
