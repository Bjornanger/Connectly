...
public class UserMeetingRegistrationFormRepository : IUserMeetingRegistrationFormRepository
{
    private readonly ApplicationDbContext _context;
    private readonly UserManager<ApplicationUser> _userManager;

    public UserMeetingRegistrationFormRepository(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
    {
        _context = context;
      
        _userManager = userManager;
    }
    public async Task<IEnumerable<UserMeetingRegistrationForm>> GetAllAsync()
    {
    ...
    public async Task<bool> AddAsync(UserMeetingRegistrationForm entity)
    {
    ...
    public async Task<bool> UserIsAlreadyRegisteredToEvent(UserMeetingRegistrationForm user)
    {
    ...
    public async Task<bool> UpdateAsync(UserMeetingRegistrationForm entity, Guid id) 
    {
    ...
    public async Task<List<UserMeetingRegistrationForm>> GetRegistrationInfoByUserIdAsync(Guid id) 
    {
