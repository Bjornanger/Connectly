...
namespace Connectly.Client.Components.Pages.AdminPages;
...
public partial class RegisteredMeetingParticipants : ComponentBase
{
    ...
    private UserMeetingRegistrationFormDto Participant { get; set; } = new();
    ...
    private void OpenUpdateParticipantModal(UserMeetingRegistrationFormDto participant)
    {
    ...
    private async Task DeleteParticipantInDbAsync(UserMeetingRegistrationFormDto participant)
    {
