...
namespace Connectly.Client.Components.Pages;

public partial class UserMeetingRegistrationForms : ComponentBase
{
    [Inject] private MultiService MultiService { get; set; }
    private UserMeetingRegistrationSparseDto UserMeetingRegistrationSparseDto { get; set; } = new();
    ...
    private const string GdprInfo =
        "CGI Sverige AB är personuppgiftsansvarig för behandlingen av de personuppgifter du lämnar till oss i samband med din anmälan till och deltagande av tillställningen. " +
